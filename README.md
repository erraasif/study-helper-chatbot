...
The application is resilient against prompt injection, instruction override, and scope escape. Strict system persona constraints force the model to treat all historical inputs as data payloads rather than system commands. Input text fields are strictly bound on both frontend and backend.
